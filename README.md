...
#### Usage
Refer to ```README```in ```pretrained_word_vectors```to download the pretrained Word2Vec model.
Run ```python text_preprocessing.py``` to clean and tokenize the questions
